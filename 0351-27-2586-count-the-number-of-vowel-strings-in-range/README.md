<h2> 351 27
2586. Count the Number of Vowel Strings in Range</h2><hr><div><p>You are given a <strong>0-indexed</strong> array of string <code>words</code> and two integers <code>left</code> and <code>right</code>.</p>
